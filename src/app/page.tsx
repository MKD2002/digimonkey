...
const perks = [
  ...
  },
  {
    ...
    Icon:CheckCircle,
    description:"Every assets on the platform is verified by our team to ensure  our highest quality standards. Not satisfied? We offer a 30-day refund guarantee."
  },
  {
    name: "For the Planet",
    Icon:Leaf,
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            ...
            <span className="text-rose-500">digital assets</span>.
          </h1>
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to Digi
            <span className="text-rose-500">Monkey</span>
